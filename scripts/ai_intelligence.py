...
def main():
 ...
 OUT.write_text(json.dumps(allout,ensure_ascii=False,indent=2),encoding='utf-8');print('DeepSeek',period,'summary generated; AI classified/risk-assessed',classified,'new high-value items');return 0
