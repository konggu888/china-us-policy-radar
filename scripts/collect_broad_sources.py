...
# Direct first-party feeds. These are collected separately from media discovery.
OFFICIAL_FEEDS=[
...
# Keep a large rolling working set; archive_news.py persists monthly history. This is not an analytical quota.
